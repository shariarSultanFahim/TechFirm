...
export const metadata = {
  ...
  description:
    "Explore transparent pricing tiers and flexible server hosting plans tailored for your business."
};
  ...
  return (
    <main className="w-full bg-[#F9FAFB] py-14 sm:py-20 lg:py-24">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="overflow-hidden rounded-3xl border border-[#EDE8F5] bg-white shadow-xs">
          <PricingSection />
        </div>
