import { ContactForm, ContactInfoCards, ContactLocationCard } from "@/components/contact";
...
export const metadata = {
  ...
  description:
    "Get in touch with TechFirm for cloud hosting, zero-trust security audits, and 24/7 managed infrastructure support."
};
  ...
  return (
    <main className="w-full bg-[#F9FAFB] py-14 sm:py-20 lg:py-24">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 grid grid-cols-1 items-stretch gap-8 sm:mb-20 lg:grid-cols-12">
