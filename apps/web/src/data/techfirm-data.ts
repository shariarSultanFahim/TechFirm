import { CaseStudyItem, FaqItem, TeamMemberItem, TestimonialItem } from "@repo/ui";
...
export const servicesData = [
  {
    ...
    description:
      "Seamless workload transition into secure, scalable AWS, Azure, and Google Cloud environments.",
    iconName: "Cloud",
    features: [
    ...
    fullContent:
      "Are you busy putting out IT fires instead of focusing on your core business? If your technology is draining resources rather than optimizing them, TechFirm's Cloud Solutions provide high-availability infrastructure, automated disaster recovery, and continuous optimization."
  },
  {
    id: "cyber-security",
    ...
    slug: "cyber-security",
    description:
      "Proactive threat intelligence, continuous endpoint monitoring, and SOC2/GDPR compliance frameworks.",
    ...
    fullContent:
      "Safeguard your mission-critical company assets with comprehensive vulnerability management, endpoint detection and response (EDR), and tailored security policies designed for modern distributed teams."
  },
  {
    id: "managed-it",
    ...
    slug: "managed-it",
    description:
      "Comprehensive outsourced IT helpdesk, network observability, and proactive hardware maintenance.",
    iconName: "Headphones",
    features: [
    ...
    fullContent:
      "Eliminate downtime with round-the-clock incident response, unified ticketing management, and proactive hardware/software patch cycles."
  },
  {
    ...
    description:
      "High-performance full-stack web, mobile, and API development with modern microservice architectures.",
    iconName: "Code2",
    features: [
    ...
    fullContent:
      "Accelerate your product roadmap with agile engineering pods specializing in scalable frontend interfaces and resilient backend services."
  },
  {
    id: "data-analytics",
    ...
    slug: "data-analytics",
    description:
      "Centralized data lakehouse engineering, ETL pipelines, and real-time executive dashboards.",
    iconName: "BarChart3",
    features: [
    ...
    fullContent:
      "Turn fragmented customer and operational data into actionable revenue-driving metrics with automated analytics pipelines."
  },
  {
    id: "it-consulting",
    ...
    slug: "it-consulting",
    description:
      "Executive technology roadmapping, enterprise software selection, and digital transformation strategy.",
    iconName: "Cpu",
    features: [
    ...
    fullContent:
      "Align technology investments directly with your 3-year strategic growth targets under the guidance of veteran enterprise architects."
  }
];
...
export const processStepsData = [
  {
    ...
    description:
      "We conduct a thorough audit of your existing infrastructure, security posture, and business objectives to identify high-impact opportunities."
  },
  {
    stepNumber: "02",
    title: "Commercial & Architecture Planning",
    description:
      "Our senior architects design a customized, cost-effective blueprint with transparent milestones, SLAs, and security controls."
  },
  {
    stepNumber: "03",
    title: "Execution & 24/7 Managed Support",
    description:
      "We deploy the solution with zero business disruption and provide continuous 24/7 monitoring, patch updates, and rapid incident response."
  }
];
...
export const caseStudiesData: CaseStudyItem[] = [
  {
    ...
    excerpt:
      "Consolidating 450+ retail point-of-sale systems into a unified real-time cloud data pipeline with zero network dropouts.",
    metrics: [
  ...
  },
  {
    ...
    excerpt:
      "Deploying automated geo-distributed Kubernetes clusters with real-time replication across Frankfurt and Amsterdam.",
    metrics: [
  ...
  },
  {
    ...
    excerpt:
      "Processing over 2 million telemetry events per minute with predictive maintenance alerts that eliminated roadside breakdowns.",
    metrics: [
