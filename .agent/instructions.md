...
- When building any page listed in ANTIGRAVITY_BUILD_PROMPT.md, use the Figma MCP tools to pull real node/layout/color/typography data before writing component code — do not rely on the JPEG exports alone.
